...
export default function UsersManagementPage() {
    ...
    const getRoleBadge = (role: string) => {
        const map: Record<string, string> = {
            ...
            admin: 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-slate-300',
            site_admin: 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-slate-300',
    ...
    return (
        <RouteGuard requiredRoles={[UserRoleEnum.ADMIN, UserRoleEnum.SUPER_ADMIN, UserRoleEnum.SITE_ADMIN]}>
            <div className="min-h-screen bg-slate-50 dark:bg-slate-900 p-4 lg:p-8 space-y-8">
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 py-2 px-4 rounded-lg text-sm font-medium transition-all duration-200 ${isActive
                                    ? 'bg-slate-900 text-white shadow-sm shadow-indigo-500/30'
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
                            ...
                            <div className="flex items-center gap-3 p-4 border-b border-slate-200 dark:border-slate-800">
                                <div className="relative flex-1 max-w-xs">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-8 pr-3 h-8 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs focus:ring-1 focus:ring-indigo-500 focus:border-slate-700 outline-none transition-colors"
                                    />
                                </div>
                            ...
                            {usersLoading ? (
                                <div className="flex items-center justify-center py-16">
                                    <div className="animate-spin rounded-full h-6 w-6 border-2 border-slate-700 border-t-transparent" />
                                </div>
                                                        ...
                                                        <div className="flex justify-center gap-2">
                                                            {r.status?.toUpperCase() !== 'COMPLETED' && (
                                                                <button
                                                                    ...
                                                                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-slate-100 dark:bg-slate-800/60 dark:bg-indigo-900/20 text-slate-900 dark:text-white dark:text-slate-300 text-[10px] font-bold hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition-colors"
                                                                >
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="p-2.5 bg-slate-100 dark:bg-slate-800/60 dark:bg-indigo-950/20 text-slate-900 dark:text-white dark:text-slate-300 rounded-xl">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full px-2.5 py-1.5 pr-8 rounded-lg border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs focus:ring-2 focus:ring-indigo-500/20 focus:border-slate-700 outline-none transition-all disabled:opacity-50"
                                                />
                                                <button
                                                    type="button"
                ...
                >
                    {fromRequestId && (
                        <div className="mb-4 p-3 bg-slate-100 dark:bg-slate-800/60 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-xl flex items-start gap-2.5">
                            <Clock className="h-4 w-4 text-slate-900 dark:text-white mt-0.5 shrink-0" />
                            <div>
                                <p className="text-[11px] font-semibold text-blue-800 dark:text-slate-300">Approving Request</p>
                                <p className="text-[10px] text-slate-900 dark:text-white dark:text-slate-300">Creating login credentials for this request will automatically notify the user.</p>
                            </div>
                        </div>
                    )}
