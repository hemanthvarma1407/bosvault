                            ...
                            {!reportData ? (
                                <div className="flex flex-col items-center justify-center min-h-[200px] p-6 text-center space-y-3">
                                    <div className="w-10 h-10 bg-slate-50 dark:bg-white/5 rounded-xl border border-dashed border-slate-200 dark:border-white/10 flex items-center justify-center">
                                        <FileText className={`h-5 w-5 ${isLoading ? 'animate-pulse text-slate-300' : 'text-slate-300'}`} />
                                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <div className="relative max-w-xs ml-auto group">
                                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-slate-400 group-focus-within:text-slate-900 dark:text-white transition-colors" />
                                <input
                                    type="text"
                                    placeholder="Search Report Matrix..."
                                    className="pl-10 pr-4 h-9 w-full bg-white/50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl text-[11px] font-bold focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-slate-700 transition-all shadow-sm"
                                    value={searchQuery}
