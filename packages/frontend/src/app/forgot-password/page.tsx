                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group/input">
                                    ...
                                    <input
                                        ...
                                        required
                                        disabled={isLoading}
                                        className={`w-full pl-9 pr-4 py-2.5 text-sm rounded-xl focus:outline-none focus:border-slate-700 focus:ring-2 focus:ring-blue-500/30 transition-all disabled:opacity-50 ${isDarkMode
